...
function createRenderer(options) {
    ...
    function processComponent(n1, n2, container, parentComponent = null, anchor = null) {
        if (!n1) {
            // 1.先挂载组件
    ...
    // 创建组件
    // TODO: NEXTTICK
    function mountComponent(vnode, container, parentComponent = null, anchor = null) {
        // debugger;
        // 1.先创建组件实例 获取实例
     ...
     * 处理 element
     */
    function processElement(n1, n2, container, parentComponent = null, anchor = null) {
        // n1 不存在就代表是初始化
        if (!n1) {
            // console.log(" init ");
     ...
     * 处理 Fragment
     */
    function processFragment(n1, n2, container, parentComponent = null, anchor = null) {
     ...
     * 挂载元素
     */
    function mountChildren(vnode, container, parentComponent = null, anchor = null) {
